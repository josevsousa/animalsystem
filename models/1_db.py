...
auth = Auth(db, host_names=myconf.get('host.names'), controller="home", function="user") #, controller="home", function="user"
service = Service()
...
#     api_key='a91c71cf5f937f232ded1e96bcadef48cd1177a5',
#     domain='dopnppmdnonbfapcaggd',
